...
import com.java.config.intercept.AccessLimitIntercept;
import com.java.config.intercept.CorsInterceptor;
import com.java.config.intercept.PageableInterceptor;
import com.java.config.intercept.TokenInterceptor;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new TokenInterceptor(userHolder, redisService)).addPathPatterns("/**");
    }
