...
import com.java.kael.entity.Dict;
import com.java.kael.entity.DictData;
import com.java.kael.enums.PublishEnum;
import com.java.kael.mapper.DictDataMapper;
import com.java.kael.service.DictDataService;
import com.java.kael.service.DictService;
...
public class DictDataServiceImpl extends ServiceImpl<DictDataMapper, DictData> implements DictDataService {
    ...
    public ResponseResult getDataByDictType(List<String> types) {
        ...
        queryWrapper.in(FieldConstants.TYPE,types).eq(FieldConstants.IS_PUBLISH, PublishEnum.PUBLISH.getCode());
        List<Dict> dictList = dictService.list(queryWrapper);
        dictList.forEach(item ->{
            QueryWrapper<DictData> sysDictDataQueryWrapper = new QueryWrapper<>();
            sysDictDataQueryWrapper.eq(FieldConstants.IS_PUBLISH, PublishEnum.PUBLISH.getCode());
            ...
            for (DictData dictData : dataList) {
                //选取默认值
                if (dictData.getIsDefault().equals(Constants.ONE)){
            ...
            result.put(Constants.LIST,dataList);
    ...
    public void isExist(DictData dictData){
        ...
        Assert.notNull(temp, ResultCode.DATA_TAG_IS_EXIST.getDesc());
    }
}
