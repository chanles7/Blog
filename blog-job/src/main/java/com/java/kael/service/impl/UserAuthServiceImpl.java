...
import com.java.kael.entity.User;
import com.java.kael.entity.UserAuth;
import com.java.kael.entity.WebConfig;
import com.java.kael.enums.LoginTypeEnum;
import com.java.kael.enums.UserStatusEnum;
import com.java.kael.exception.BusinessException;
import com.java.kael.mapper.UserAuthMapper;
import com.java.kael.service.*;
import com.java.kael.strategy.context.SocialLoginStrategyContext;
import com.java.kael.util.AesEncryptUtils;
...
public class UserAuthServiceImpl extends ServiceImpl<UserAuthMapper, UserAuth> implements UserAuthService {
    ...
    public ResponseResult emailRegister(EmailRegisterDTO vo) {
        ...
        WebConfig config = webConfigService.getOne(new QueryWrapper<WebConfig>().last(FieldConstants.LIMIT_ONE));
    ...
    public ResponseResult updatePassword(EmailRegisterDTO vo) {
        ...
        return update  ? ResponseResult.success("修改成功"): ResponseResult.error(ResultCode.ERROR_DEFAULT.getDesc());
    }
    ...
    public ResponseResult emailLogin(EmailLoginDTO vo) {
        ...
        Assert.isTrue(user.getStatus() == UserStatusEnum.normal.code, ResultCode.EMAIL_DISABLE_LOGIN.getDesc());
    ...
    public ResponseResult bindEmail(UserAuthDTO vo) {
        ...
        return update ? ResponseResult.success("绑定邮箱成功"): ResponseResult.error(ResultCode.ERROR_DEFAULT.getDesc());
    }
    ...
    public ResponseResult updateUser(UserAuthDTO vo) {
        ...
        boolean update = updateById(userAuth);
        return update ? ResponseResult.success("修改信息成功"): ResponseResult.error(ResultCode.ERROR_DEFAULT.getDesc());
    }
    ...
    public void checkEmail(String email){
        ...
        Assert.isTrue(matches, ResultCode.EMAIL_ERROR.getDesc());
    }
    ...
    private void checkCode(String key, String sourCode) {
        ...
        Assert.isTrue(code != null && code.equals(sourCode), ResultCode.ERROR_EXCEPTION_MOBILE_CODE.getDesc());
    }
}
