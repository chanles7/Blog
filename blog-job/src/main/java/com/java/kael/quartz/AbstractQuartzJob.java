...
import com.java.kael.entity.JobLog;
import com.java.kael.enums.ScheduleConstants;
import com.java.kael.mapper.JobLogMapper;
import com.java.kael.util.SpringUtils;
...
public abstract class AbstractQuartzJob implements org.quartz.Job {
    ...
    protected void after(JobExecutionContext context, Job job, Exception e) {
        ...
        if (e != null) {
            jobLog.setStatus(Constants.ONE);
            ...
            jobLog.setStatus(Constants.ZERO);
        }
