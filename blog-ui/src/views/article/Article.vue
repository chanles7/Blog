<template>
  <div>
    ...
    <v-row class="article-container">
      <v-col md="9" cols="12">
        <v-card class="article-wrapper">
          <article v-show="!isCheck" id="write" class="article-content markdown-body" v-html="article.content" ref="article" />
    ...
    <div>
      <el-dialog title="加载校验" :visible.sync="dialogVisible" width="30%">
        <div style="display :flex;justify-content: center;">
          <font>扫码关注公众号「<span style="color: #005cc5">北极星</span>」</font><br />
        </div>
        <div style="display :flex;justify-content: center;">
