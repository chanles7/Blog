<template>
  <div class="dashboard-editor-container">
    ...
    <el-dialog title="通知" :close-on-click-modal="false" :visible.sync="centerDialogVisible" width="50%" :before-close="closeNotificationDialogVisible" center>
...
export default {
  ...
  methods: {
    ...
    initCategoryChart: function (categoryList, result) {
      this.categoryChart = echarts.init(
